...
async function run() {
  try {
    ...
    // for usage facility
    const coffeeCollection = client.db('CoffeeDBsecond').collection('coffee')

    const userCollection = client.db('CoffeeDBsecond').collection('users')
    ...
    // closing below line for don't get closed
    // await client.close();
  }
}
